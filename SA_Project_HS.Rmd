...
```{r}
#km curve
km_eco = survfit(Surv(ds$months, ds$status2)~ds$ecosystem)
#plot
ggsurvplot(
  fit=km_eco,
  data=ds,
...
#km curve
km_repo = survfit(Surv(ds$months, ds$status2)~ds$repoType)
#plot
ggsurvplot(
  fit=km_repo,
  data=ds,
...
#km curve
km_size = survfit(Surv(ds$months, ds$status2)~ds$sizeUsers)
#plot
ggsurvplot(
  fit=km_size,
  data=ds,
